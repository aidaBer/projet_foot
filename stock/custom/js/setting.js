$(document).ready(function() {
	...
	$("#changeUsernameForm").unbind('submit').bind('submit', function() {
		...
		if(username == "") {
			$("#username").after('<p class="text-danger">Le Pseudo est requis</p>');
	...
	$("#changePasswordForm").unbind('submit').bind('submit', function() {
		...
		if(currentPassword == "" || newPassword == "" || conformPassword == "") {
			if(currentPassword == "") {
				$("#password").after('<p class="text-danger">Le mot de passe actuel est requis</p>');
			...
			if(newPassword == "") {
				$("#npassword").after('<p class="text-danger">Le nouveau mot de passe est requis</p>');
			...
			if(conformPassword == "") {
				$("#cpassword").after('<p class="text-danger">La confirmation du mot de passe est requis</p>');
